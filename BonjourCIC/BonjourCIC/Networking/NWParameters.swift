...
extension NWParameters {
    ...
    convenience init(passcode: String) {
        ...
        let gameOptions = NWProtocolFramer.Options(definition: ApplicationProtocol.definition)
    ...
    private static func tlsOptions(passcode: String) -> NWProtocolTLS.Options {
        ...
        var authenticationCode = HMAC<SHA256>.authenticationCode(for: ApplicationProtocol.label.data(using: .utf8)!, using: authenticationKey)
        ...
        sec_protocol_options_add_pre_shared_key(tlsOptions.securityProtocolOptions,
                                                ...
                                                stringToDispatchData(ApplicationProtocol.label)! as __DispatchData)
